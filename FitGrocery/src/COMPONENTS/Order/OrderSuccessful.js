...
const OrderSuccessful = ({ orderid, message, redirecto }) => {
    ...
    const [orderdata, setorderdata] = useState({
        ...
        CustomerName: 'ADARSH M S',
        CustomerShipToAddress: 'B-101, Shreeji Apartment, Near Shreeji Hospital, Coimbatore 625008',
        ...
        Tax: 100,
        // ShippingCharges: 80,
        Total: 'Your Total Bill will be provided during delivery',
